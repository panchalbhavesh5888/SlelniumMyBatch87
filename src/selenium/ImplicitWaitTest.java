...
public class ImplicitWaitTest {
	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20)); //max wait time- if if finds element then perfomr action immidately and move to next step(not like thred.sleep:wait for fox time)
